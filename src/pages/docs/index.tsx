    ...
    content: (
      <div style={{ fontSize: '13px', color: '#94a3b8', lineHeight: '1.8' }}>
        <p style={{ margin: '0 0 12px' }}>
          ConnectorHub manages authenticated connections to third-party SaaS providers.
...
Manual re-trigger required after root cause resolution.`} />
  ...
  },
  {
    ...
    content: (
      <div style={{ fontSize: '13px', color: '#94a3b8', lineHeight: '1.8' }}>
        <p style={{ margin: '0 0 12px' }}>Each provider enforces its own API rate limits. ConnectorHub tracks usage per window and pauses syncs when approaching limits.</p>
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
          <thead>
            <tr style={{ borderBottom: '1px solid #1e2530' }}>
